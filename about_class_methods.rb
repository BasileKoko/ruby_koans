...
class AboutClassMethods < Neo::Koan
  ...
  def test_objects_are_objects
    fido = Dog.new
    # The instance fido of class Dog is an Object
  ...
  def test_objects_have_methods
    fido = Dog.new
    # The instance fido of class Dog has 100 methods
    assert fido.methods.size > 1
  end

  def test_classes_have_methods
    # The class Dog has 100 methods
  ...
  def test_you_can_define_methods_on_individual_objects
    ...
    #calling method fido.wag return the symbol :fidos_wag inside the method
  ...
  def test_other_objects_are_not_affected_by_these_singleton_methods
    ...
    # There is no method called wag (method fido.wag is not equal to method wag)
